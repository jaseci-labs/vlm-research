...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset-repo", type=str, default="RR32444/flickr_subset", help="Fallback image folder (if dataset items are paths)")
    ...
    try:
        test_subset = load_dataset("RR32444/flickr_subset")['test']
