#!/bin/bash
# ============================================================================
# This script fine-tunes the Gemma-3-12B-IT model on Flickr30k dataset.
...
TRAIN_DATASET="./flickr30k_splits/train"
EVAL_DATASET="./flickr30k_splits/eval"
SAVE_DIR_BASE="./flickr30k_finetuned"

# HuggingFace upload (set to true to enable)
UPLOAD_TO_HF=false
HF_TOKEN=""        # Add your HuggingFace token here
HF_REPO_BASE=""    # Base repo ID (e.g., "Hushan-10/vlm-finetunes")
...
echo "============================================================================"
echo "🚀 Flickr30k Fine-tuning Script"
echo "============================================================================"
echo ""
