#!/bin/bash
# ============================================================================
# Fine-tunes the model on KIE dataset (TOTAL AMOUNT PREDICTION TASK).
...
# 🔴 Changed only to separate from old-task checkpoints
SAVE_DIR_BASE="./kie_finetuned_total"
...
echo "============================================================================"
echo "🚀 KIE Fine-tuning Script (TOTAL AMOUNT TASK)"
echo "============================================================================"
echo ""
...
# Parse prompts count
PROMPTS_COUNT=$(echo "$PROMPTS_JSON" | python3 -c \
