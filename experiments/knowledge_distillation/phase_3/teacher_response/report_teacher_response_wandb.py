...
wandb.init(project="Distillation with RSICD", name="Qwen 72-B Teacher Response")
JSON_PATH = "/home/malitha/programming/vlm-research/experiments/knowledge_distillation/phase_3/image_dataset/res_normalized.json"
