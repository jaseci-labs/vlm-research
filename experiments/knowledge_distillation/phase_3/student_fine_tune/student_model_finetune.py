...
if __name__ == "__main__":
    ...
    trainer_phase_1 = configuration_for_training(model, tokenizer, train_data_phase_1, val_data_phase_1, 0.1)
    ...
    trainer_phase_2 = configuration_for_training(model, tokenizer, train_data_phase_2, val_data_phase_2, 0.3)
