from transformers import AutoProcessor, Gemma3nForConditionalGeneration, AutoModelForCausalLM
...
wandb.init(project="OCR with Gemma3", name="Loading base Model")
...
for i, row in enumerate(test_ds):
    ...
    memory_usages.append(memory_used_MB)
